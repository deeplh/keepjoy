	 ...
	 <el-card class="box-card">
	    <div class="post-filter">
		  ...
		  <el-form-item label="typeId" prop="typeId">
					    	...
					    	<el-input-number v-model="form.typeId"></el-input-number>
...
<script type="text/javascript">
	new Vue({
		...
		methods:{		     
		      ...
		      search:function(){
	            var vueThis=this;	
			   	doAjax({url:"admin/usertyperelation/search.action",data:this.form,successCallback:function(data){	
					vueThis.list=data;
			 	}}); 
		      },
		      remove:function(index,id) {		    	  
		    	  var vueThis = this;
		    	  doAjax({url:'admin/usertyperelation/remove.action',data:{ id:id},
	        ...
	        resetForm:function(formName) {
		      ...
		      goToDetail:function(id){
		    	  openInnerPage("admin/modules/usertyperelation/update.jsp",{id:id});
		      }
		}
	});
