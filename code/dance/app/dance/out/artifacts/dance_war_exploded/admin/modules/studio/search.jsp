...
<script type="text/javascript">
	new Vue({
		...
		methods:{		     
		      ...
		      search:function(){
	            var vueThis=this;	
			   	doAjax({url:"admin/studio/search.action",data:this.form,successCallback:function(data){	
					vueThis.list=data;
			 	}}); 
		      },
		      remove:function(index,id) {		    	  
		    	  var vueThis = this;
		    	  doAjax({url:'admin/studio/remove.action',data:{ id:id},
	        ...
	        resetForm:function(formName) {
		      ...
		      goToDetail:function(id){
		    	  openInnerPage("admin/modules/studio/update.jsp",{id:id});
		      }
		}
	});
