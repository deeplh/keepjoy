...
@JsonTagAnnotation(actionValue="/approve",namespace="app/event")
public class ApproveEvent extends JsonTagTemplateDaoImpl implements IDoService<String> {
	...
	public String doService() throws Exception {
		TblDanceUserEventRelation t=get(TblDanceUserEventRelation.class,this.id);
