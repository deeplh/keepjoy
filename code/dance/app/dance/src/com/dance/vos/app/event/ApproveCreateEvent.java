...
@JtOnlineApi(describe="修改event的状态",name="")
@JsonTagAnnotation(actionValue="/approve",namespace="app/event/create")
public class ApproveCreateEvent extends JsonTagTemplateDaoImpl implements IDoService<String> {
	...
	public String doService() throws Exception {
		TblDanceEvent t=get(TblDanceEvent.class,this.id);
