...
<script type="text/javascript">
	new Vue({
		...
		methods:{		     
		      ...
		      search:function(){
	            var vueThis=this;	
			   	doAjax({url:"admin/style/search.action",data:this.form,successCallback:function(data){	
					vueThis.list=data;
			 	}}); 
		      },
		      remove:function(index,id) {		    	  
		    	  var vueThis = this;
		    	  doAjax({url:'admin/style/remove.action',data:{ id:id},
	        ...
	        resetForm:function(formName) {
		      ...
		      goToDetail:function(id){
		    	  openInnerPage("admin/modules/style/update.jsp",{id:id});
		      }
		}
	});
